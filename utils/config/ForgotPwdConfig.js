...
const mailToSendForgot = {
    ...
    sendMailForgot: async (req, res) => {
      const activationCodeForgotPass = req.activationCodeForgotPass;
                  ...
                  <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 60px;font-family:'Open Sans',sans-serif;" align="left">
                    ...
                    <div class="v-text-align" align="center" style="margin-top: 10px;">
                      <p style="margin-bottom: 10px; ">
                        <a target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #FA8072; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:8%; max-width:30%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #CCC; border-top-style: dashed; border-top-width: 0px; border-left-color: #CCC; border-left-style: dashed; border-left-width: 0px; border-right-color: #CCC; border-right-style: dashed; border-right-width: 0px; border-bottom-color: #CCC; border-bottom-style: dashed; border-bottom-width: 0px;font-family: helvetica,sans-serif; font-size: 17px;">
                          <span style="display:block;padding:10px 20px;line-height:120%;">
                            <strong><span style="line-height: 20.4px;">${activationCodeForgotPass}</span></strong>
                          </span>
                        </a>
                      </p>
                    </div>
